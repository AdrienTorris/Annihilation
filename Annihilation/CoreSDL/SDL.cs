...
#error Unsupported platform
        ...
        public static class Hints
        {
            ...
            private const string FrameBufferAccelerationString = "FRAMEBUFFER_ACCELERATION";
            private const string RenderDriverString = "RENDER_DRIVER";
            private const string RenderOpenglShadersString = "RENDER_OPENGL_SHADERS";
            private const string RenderDirect3DThreadsafeString = "RENDER_DIRECT3D_THREADSAFE";
            private const string RenderDirect3D11DebugString = "RENDER_DIRECT3D11_DEBUG";
            private const string RenderScaleQualityString = "RENDER_SCALE_QUALITY";
            private const string RenderVsyncString = "RENDER_VSYNC";
            private const string VideoAllowScreensaveString = "VIDEO_ALLOW_SCREENSAVER";
            private const string VideoX11XvidModeString = "VIDEO_X11_XVIDMODE";
            private const string VideoX11XineramaString = "VIDEO_X11_XINERAMA";
            private const string VideoX11XRandRString = "VIDEO_X11_XRANDR";
            private const string VideoX11NetWMPingString = "VIDEO_X11_NET_WM_PING";
            private const string WindowFrameUsableWhileCursorHiddenString = "WINDOW_FRAME_USABLE_WHILE_CURSOR_HIDDEN";
            private const string WindowsEnableMessageLoopString = "WINDOWS_ENABLE_MESSAGELOOP";
            private const string GrabKeyboardString = "GRAB_KEYBOARD";
            private const string MouseRelativeModeWarpString = "MOUSE_RELATIVE_MODE_WARP";
            private const string MouseFocusClickThroughString = "MOUSE_FOCUS_CLICKTHROUGH";
            private const string VideoMinimizeOnFocusLossString = "VIDEO_MINIMIZE_ON_FOCUS_LOSS";
            private const string IdleTimerDisabledString = "IOS_IDLE_TIMER_DISABLED";
            private const string OrientationsString = "IOS_ORIENTATIONS";
            private const string AppleTVControllerUIEventsString = "APPLE_TV_CONTROLLER_UI_EVENTS";
            private const string AppleTVRemoteAllowRotationString = "APPLE_TV_REMOTE_ALLOW_ROTATION";
            private const string AccelerometerAsJoystickString = "ACCELEROMETER_AS_JOYSTICK";
            private const string XInputEnabledString = "XINPUT_ENABLED";
            private const string XInputUseOldJoystickMappingString = "XINPUT_USE_OLD_JOYSTICK_MAPPING";
            private const string GameControllerConfigString = "GAMECONTROLLERCONFIG";
            private const string JoystickAllowBackgroundEventsString = "JOYSTICK_ALLOW_BACKGROUND_EVENTS";
            private const string AllowTopmostString = "ALLOW_TOPMOST";
            private const string TimerResolutionString = "TIMER_RESOLUTION";
            private const string ThreadStackSizeString = "THREAD_STACK_SIZE";
            private const string VideoHighDPIDisabledString = "VIDEO_HIGHDPI_DISABLED";
            private const string MacCtrlClickEmulateRightClickString = "MAC_CTRL_CLICK_EMULATE_RIGHT_CLICK";
            private const string VideoWinD3DCompilerString = "VIDEO_WIN_D3DCOMPILER";
            private const string VideoWindowSharePixelFormatString = "VIDEO_WINDOW_SHARE_PIXEL_FORMAT";
            private const string WinRTPrivacyPolicyURLString = "WINRT_PRIVACY_POLICY_URL";
            private const string WinRTPrivacyPolicyLabelString = "WINRT_PRIVACY_POLICY_LABEL";
            private const string WinRTHandleBackButtonString = "WINRT_HANDLE_BACK_BUTTON";
            private const string VideoMacFullscreenSpacesString = "VIDEO_MAC_FULLSCREEN_SPACES";
            private const string MacBackgroundAppString = "MAC_BACKGROUND_APP";
            private const string AndroidAPKExpansionMainFileVersionString = "ANDROID_APK_EXPANSION_MAIN_FILE_VERSION";
            private const string AndroidAPKExpansionPatchFileVersionString = "ANDROID_APK_EXPANSION_PATCH_FILE_VERSION";
            private const string IMEInternalEditingString = "IME_INTERNAL_EDITING";
            private const string AndroidSeparateMouseAndTouchString = "ANDROID_SEPARATE_MOUSE_AND_TOUCH";
            private const string EmscriptenKeyboardElementString = "EMSCRIPTEN_KEYBOARD_ELEMENT";
            private const string NoSignalHandlersString = "NO_SIGNAL_HANDLERS";
            private const string WindowsNoCloseOnAltF4String = "WINDOWS_NO_CLOSE_ON_ALT_F4";
            private const string BMPSaveLegacyFormatString = "BMP_SAVE_LEGACY_FORMAT";
            private const string WindowsDisableThreadWarningString = "WINDOWS_DISABLE_THREAD_NAMING";
            private const string RPIVideoLayerString = "RPI_VIDEO_LAYER";

            public static readonly byte* False = Utf8.AllocateFromString("0");
            public static readonly byte* True = Utf8.AllocateFromString("1");

            public static readonly byte* FrameBufferAcceleration = Utf8.AllocateFromString("FRAMEBUFFER_ACCELERATION");
            public static readonly byte* RenderDriver = Utf8.AllocateFromString("RENDER_DRIVER");
            public static readonly byte* RenderOpenglShaders = Utf8.AllocateFromString("RENDER_OPENGL_SHADERS");
            public static readonly byte* RenderDirect3DThreadsafe = Utf8.AllocateFromString("RENDER_DIRECT3D_THREADSAFE");
            public static readonly byte* RenderDirect3D11Debug = Utf8.AllocateFromString("RENDER_DIRECT3D11_DEBUG");
            public static readonly byte* RenderScaleQuality = Utf8.AllocateFromString("RENDER_SCALE_QUALITY");
            public static readonly byte* RenderVsync = Utf8.AllocateFromString("RENDER_VSYNC");
            public static readonly byte* VideoAllowScreensave = Utf8.AllocateFromString("VIDEO_ALLOW_SCREENSAVER");
            public static readonly byte* VideoX11XvidMode = Utf8.AllocateFromString("VIDEO_X11_XVIDMODE");
            public static readonly byte* VideoX11Xinerama = Utf8.AllocateFromString("VIDEO_X11_XINERAMA");
            public static readonly byte* VideoX11XRandR = Utf8.AllocateFromString("VIDEO_X11_XRANDR");
            public static readonly byte* VideoX11NetWMPing = Utf8.AllocateFromString("VIDEO_X11_NET_WM_PING");
            public static readonly byte* WindowFrameUsableWhileCursorHidden = Utf8.AllocateFromString("WINDOW_FRAME_USABLE_WHILE_CURSOR_HIDDEN");
            public static readonly byte* WindowsEnableMessageLoop = Utf8.AllocateFromString("WINDOWS_ENABLE_MESSAGELOOP");
            public static readonly byte* GrabKeyboard = Utf8.AllocateFromString("GRAB_KEYBOARD");
            public static readonly byte* MouseRelativeModeWarp = Utf8.AllocateFromString("MOUSE_RELATIVE_MODE_WARP");
            public static readonly byte* MouseFocusClickThrough = Utf8.AllocateFromString("MOUSE_FOCUS_CLICKTHROUGH");
            public static readonly byte* VideoMinimizeOnFocusLoss = Utf8.AllocateFromString("VIDEO_MINIMIZE_ON_FOCUS_LOSS");
            public static readonly byte* IdleTimerDisabled = Utf8.AllocateFromString("IOS_IDLE_TIMER_DISABLED");
            public static readonly byte* Orientations = Utf8.AllocateFromString("IOS_ORIENTATIONS");
            public static readonly byte* AppleTVControllerUIEvents = Utf8.AllocateFromString("APPLE_TV_CONTROLLER_UI_EVENTS");
            public static readonly byte* AppleTVRemoteAllowRotation = Utf8.AllocateFromString("APPLE_TV_REMOTE_ALLOW_ROTATION");
            public static readonly byte* AccelerometerAsJoystick = Utf8.AllocateFromString("ACCELEROMETER_AS_JOYSTICK");
            public static readonly byte* XInputEnabled = Utf8.AllocateFromString("XINPUT_ENABLED");
            public static readonly byte* XInputUseOldJoystickMapping = Utf8.AllocateFromString("XINPUT_USE_OLD_JOYSTICK_MAPPING");
            public static readonly byte* GameControllerConfig = Utf8.AllocateFromString("GAMECONTROLLERCONFIG");
            public static readonly byte* JoystickAllowBackgroundEvents = Utf8.AllocateFromString("JOYSTICK_ALLOW_BACKGROUND_EVENTS");
            public static readonly byte* AllowTopmost = Utf8.AllocateFromString("ALLOW_TOPMOST");
            public static readonly byte* TimerResolution = Utf8.AllocateFromString("TIMER_RESOLUTION");
            public static readonly byte* ThreadStackSize = Utf8.AllocateFromString("THREAD_STACK_SIZE");
            public static readonly byte* VideoHighDPIDisabled = Utf8.AllocateFromString("VIDEO_HIGHDPI_DISABLED");
            public static readonly byte* MacCtrlClickEmulateRightClick = Utf8.AllocateFromString("MAC_CTRL_CLICK_EMULATE_RIGHT_CLICK");
            public static readonly byte* VideoWinD3DCompiler = Utf8.AllocateFromString("VIDEO_WIN_D3DCOMPILER");
            public static readonly byte* VideoWindowSharePixelFormat = Utf8.AllocateFromString("VIDEO_WINDOW_SHARE_PIXEL_FORMAT");
            public static readonly byte* WinRTPrivacyPolicyURL = Utf8.AllocateFromString("WINRT_PRIVACY_POLICY_URL");
            public static readonly byte* WinRTPrivacyPolicyLabel = Utf8.AllocateFromString("WINRT_PRIVACY_POLICY_LABEL");
            public static readonly byte* WinRTHandleBackButton = Utf8.AllocateFromString("WINRT_HANDLE_BACK_BUTTON");
            public static readonly byte* VideoMacFullscreenSpaces = Utf8.AllocateFromString("VIDEO_MAC_FULLSCREEN_SPACES");
            public static readonly byte* MacBackgroundApp = Utf8.AllocateFromString("MAC_BACKGROUND_APP");
            public static readonly byte* AndroidAPKExpansionMainFileVersion = Utf8.AllocateFromString("ANDROID_APK_EXPANSION_MAIN_FILE_VERSION");
            public static readonly byte* AndroidAPKExpansionPatchFileVersion = Utf8.AllocateFromString("ANDROID_APK_EXPANSION_PATCH_FILE_VERSION");
            public static readonly byte* IMEInternalEditing = Utf8.AllocateFromString("IME_INTERNAL_EDITING");
            public static readonly byte* AndroidSeparateMouseAndTouch = Utf8.AllocateFromString("ANDROID_SEPARATE_MOUSE_AND_TOUCH");
            public static readonly byte* EmscriptenKeyboardElement = Utf8.AllocateFromString("EMSCRIPTEN_KEYBOARD_ELEMENT");
            public static readonly byte* NoSignalHandlers = Utf8.AllocateFromString("NO_SIGNAL_HANDLERS");
            public static readonly byte* WindowsNoCloseOnAltF4 = Utf8.AllocateFromString("WINDOWS_NO_CLOSE_ON_ALT_F4");
            public static readonly byte* BMPSaveLegacyFormat = Utf8.AllocateFromString("BMP_SAVE_LEGACY_FORMAT");
            public static readonly byte* WindowsDisableThreadWarning = Utf8.AllocateFromString("WINDOWS_DISABLE_THREAD_NAMING");
            public static readonly byte* RPIVideoLayer = Utf8.AllocateFromString("RPI_VIDEO_LAYER");
        }
        ...
        public struct Event
        {
            ...
            [FieldOffset(0)] public CommonEvent CommonEvent;
            [FieldOffset(0)] public WindowEvent WindowEvent;
            [FieldOffset(0)] public KeyboardEvent KeyEvent;
            [FieldOffset(0)] public TextEditingEvent TextEditingEvent;
            [FieldOffset(0)] public TextInputEvent TextInputEvent;
            [FieldOffset(0)] public MouseMotionEvent MouseMotionEvent;
            [FieldOffset(0)] public MouseButtonEvent MouseButtonEvent;
            [FieldOffset(0)] public MouseWheelEvent MouseWheelEvent;
            [FieldOffset(0)] public JoystickAxisEvent JoystickAxisEvent;
            [FieldOffset(0)] public JoystickBallEvent JoystickBallEvent;
            [FieldOffset(0)] public JoystickHatEvent JoystickHatEvent;
            [FieldOffset(0)] public JoystickButtonEvent JoystickButtonEvent;
            [FieldOffset(0)] public JoystickDeviceEvent JoystickDeviceEvent;
            [FieldOffset(0)] public ControllerAxisEvent ControllerAxisEvent;
            [FieldOffset(0)] public ControllerButtonEvent ControllerButtonEvent;
            [FieldOffset(0)] public ControllerDeviceEvent ControllerDeviceEvent;
            [FieldOffset(0)] public AudioDeviceEvent AudioDeviceEvent;
            [FieldOffset(0)] public QuitEvent QuitEvent;
            [FieldOffset(0)] public UserEvent UserEvent;
            [FieldOffset(0)] public SysWMEvent SysWMEvent;
            [FieldOffset(0)] public TouchFingerEvent ToughFingerEvent;
            [FieldOffset(0)] public MultiGestureEvent MultiGestureEvent;
            [FieldOffset(0)] public DollarGestureEvent DollarGestureEvent;
        ...
        [DllImport(LibraryName, EntryPoint = "SDL_Vulkan_CreateSurface")]
        public static extern bool VulkanCreateSurface(Window window, IntPtr instance, out ulong surface);
