...
namespace Vulkan
{
    ...
    public unsafe delegate VkResult VkGetPhysicalDeviceSurfaceFormatsKHR(VkPhysicalDevice physicalDevice, VkSurface surface, ref uint surfaceFormatCount, VkSurfaceFormat* surfaceFormats);
    public unsafe delegate VkResult VkGetPhysicalDeviceSurfacePresentModesKHR(VkPhysicalDevice physicalDevice, VkSurface surface, ref uint presentModeCount, VkPresentMode* presentModes);
    ...
    public unsafe delegate VkResult VkGetSwapchainImagesKHR(VkDevice device, VkSwapchain swapchain, ref uint swapchainImageCount, VkImage* swapchainImages);
    ...
    public unsafe delegate VkResult VkGetPhysicalDeviceDisplayPropertiesKHR(VkPhysicalDevice physicalDevice, ref uint propertyCount, VkDisplayProperties* properties);
    public unsafe delegate VkResult VkGetPhysicalDeviceDisplayPlanePropertiesKHR(VkPhysicalDevice physicalDevice, ref uint propertyCount, VkDisplayPlaneProperties* properties);
    public unsafe delegate VkResult VkGetDisplayPlaneSupportedDisplaysKHR(VkPhysicalDevice physicalDevice, uint planeIndex, ref uint displayCount, VkDisplay* displays);
    public unsafe delegate VkResult VkGetDisplayModePropertiesKHR(VkPhysicalDevice physicalDevice, VkDisplay display, ref uint propertyCount, VkDisplayModeProperties* properties);
