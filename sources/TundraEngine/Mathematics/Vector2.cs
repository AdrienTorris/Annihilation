...
namespace TundraEngine.Mathematics
{
    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        {
            return Abs ((X * X) + (Y * Y) - 1f) < MathUtility.ZeroTolerance;
        }
        ...
        {
            return Abs (other.X - X) < MathUtility.ZeroTolerance && Abs (other.Y - Y) < MathUtility.ZeroTolerance;
        }
